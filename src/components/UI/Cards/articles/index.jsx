...
import { DoteIcon, HeartIcons, MessegeIcons } from "../../icons"
import cls from "./Articles.module.scss"

export default function ArticlesCard({ avatar, tag = [], like, owner, commit, title, text, img = [], commitUser, likeUser, center, onClick, ...other }) {
    return (
        <>
            {owner ? <div className={cls.Articles__sett}>
                hello
            </div> : ""}
            <div className={cls.Articles} {...other}>
                <div className={cls.Articles__top}>
                    ...
                    {owner && <div className={cls.Articles__left}>
                        <div className={cls.Articles__left__round}>
                            <DoteIcon />
                        </div>
                    </div>}
                </div>
